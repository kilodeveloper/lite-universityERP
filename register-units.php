...
$stmt->execute();
echo"<script>alert('Successfully Registered Units');</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Unit Registration Panel</h4>
...
<input type="submit" name="submit" Value="Register Units"class="btn btn-success mr-2 ">
</div>
</form>
